...
int main(int argc, char* argv[])
{
	try
	{
		if (argc == 4)
		{
			...
			char buf[33]; // Increase the buffer size
			...
			LPCWSTR path1 = L"D:\\BSTU\\3_course\\1term\\OperatingSystems\\Lab5\\OS05_01\\x64\\Debug\\OS05_02x.exe";
			LPCWSTR path2 = L"D:\\BSTU\\3_course\\1term\\OperatingSystems\\Lab5\\OS05_01\\x64\\Debug\\OS05_02x.exe";
