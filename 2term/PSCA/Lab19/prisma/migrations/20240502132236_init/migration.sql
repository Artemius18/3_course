...
CREATE TABLE [dbo].[commits] (
    ...
    [repoId] INT,
    [message] VARCHAR(255),
    CONSTRAINT [PK__commits__3213E83F26A36CF5] PRIMARY KEY CLUSTERED ([id])
);
...
CREATE TABLE [dbo].[repos] (
    ...
    CONSTRAINT [PK__repos__3213E83F6B2A8506] PRIMARY KEY CLUSTERED ([id])
);
...
CREATE TABLE [dbo].[users] (
    ...
    CONSTRAINT [PK__users__3213E83FCD9160E1] PRIMARY KEY CLUSTERED ([id])
);
